...
const gens = [kantoPokemons, johtoPokemons, hoennPokemons, sinnohPokemons, unovaPokemons, kalosPokemons, alolaPokemons, galarPokemons, paldeaPokemons]
export const pokemon = ():string[] => {
    ...
    console.log(pokemon.length + " pokemon added currently!")
    return pokemon;
}
